...
public class NegativeSliderTextFieldPanel extends JPanel {
    ...
    public NegativeSliderTextFieldPanel(int min, int max, int startValue, String text)
    {
        slider = new JSlider(JSlider.HORIZONTAL, min, max, startValue);
        JTextField field = new JTextField(startValue + "",3);
