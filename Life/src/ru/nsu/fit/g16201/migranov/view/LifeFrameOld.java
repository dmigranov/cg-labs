...
//public class LifeFrameOld extends JFrame {
public class LifeFrameOld extends MainFrame {
    public static void main(String[] args) throws Exception
    {
        new LifeFrameOld();
    }

    private LifeFrameOld() throws Exception {
        //инициализация
    ...
    public void onOpen()
    {
        ...
        //TODO: можно было бы открыть тут, но как же контроллер?
    }
}
